...
class TrafficSourceCategoryRequest extends FormRequest
{
    ...
    {
        $trafficSourceCategoryId = $this->route('traffic_source_category')?->id;
        ...
        return [
            ...
            'slug' => [
                ...
                'max:191',
                'regex:/^[a-z0-9_]+$/',
                Rule::unique('traffic_source_categories', 'slug')->ignore($trafficSourceCategoryId),
            ],
