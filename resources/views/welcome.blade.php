    ...
    <header class="fixed top-0 left-0 right-0 z-50 glass-effect border-b border-blue-500/10">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <!-- Login Button -->
                <button class="px-5 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 rounded-lg transition-all duration-300 shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40">
                    Login
                </button>
            </div>
        </div>
    ...
    <main class="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up" style="animation-delay: 0.2s;">
                ...
                <button class="w-full sm:w-auto px-8 py-4 text-base font-medium text-gray-400 hover:text-white border border-gray-700 hover:border-gray-600 rounded-xl transition-all duration-300 hover:bg-white/5">
                    Acessar painel
                </button>
            </div>
